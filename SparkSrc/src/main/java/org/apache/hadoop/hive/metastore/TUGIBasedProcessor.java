...
public class TUGIBasedProcessor<I extends Iface> extends TSetIpAddressProcessor<Iface> {
  ...
  {
    super(iface);
    System.out.println("*****Overridden TUGI");
    this.iface = iface;
  ...
  public boolean process(final TProtocol in, final TProtocol out) throws TException {
    ...
    System.out.println("*****Overridden TUGI: clientUGI in process " + clientUgi);
    if (null == clientUgi){
  ...
  private void handleSetUGI(TUGIContainingTransport ugiTrans,
    ...
    UserGroupInformation clientUgi = ugiTrans.getClientUGI();
    System.out.println("*****Overridden TUGI: clientUGI " + clientUgi);
    if( null != clientUgi){
    ...
    System.out.println("*****Overridden TUGI: principals " + principals.toString());
